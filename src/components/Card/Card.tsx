  ...
  return (
    <div className="relative z-0 flex h-screen p-8">
      ...
      <div className="absolute top-[43%] left-[48%] transform -translate-y-1/2">
        <h1 className="text-shadow-md font-robot text-6xl lg:text-6xl font-bold text-white mb-4">Breaking Bad</h1>
        ...
        <p className=" font-roboto text-white text-lg lg:text-sm max-w-lg">
